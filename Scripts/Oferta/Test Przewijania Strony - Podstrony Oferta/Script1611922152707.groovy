...
WebUI.scrollToElement(findTestObject('SPY-OFERTA/div_Twj koszyk_topcontrol/iframe__fm-fc-f-jquodjjgyu'), 0)

WebUI.click(findTestObject('SPY-OFERTA/div_Twj koszyk_topcontrol/div_Twj koszyk_topcontrol'))
